...
const UploadIcon = ({ width = '2rem', height = '2rem', className = '' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
const MoreIcon = ({ width = '2rem', height = '2rem', className = '' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
const KeyboardShortcutIcon = ({ width = '2rem', height = '2rem', className = '' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
const CoinIcon = ({ width = '2rem', height = '2rem', className = '' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
const CreatorCenterIcon = ({ width = '2rem', height = '2rem', className = '' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
